...
| <new pattern, no existing skill is a real home> | <draft a new skill through writing-for-agents> | <new skill: <kebab-name>> |
...
For each item, describe the pattern, what was hit, and the suggested mechanism. The parent reports these to the user. Nothing is filed to a tracker automatically.
